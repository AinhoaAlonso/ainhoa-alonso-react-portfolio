...
export default class PortfolioItem extends Component {
    ...
    render(){
        ...
        return (
            //Creamos un link que pulsando en cualquier parte de nuestros portfolios nos va al detalle, portfolio-detail.js, hay que poner el id para que sepa a cual tiene que ir
